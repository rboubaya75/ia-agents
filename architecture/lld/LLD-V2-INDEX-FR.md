...
V2-LLD-006	Données, mémoire, rétention et restauration	modèles, cycle de vie, TTL, backup, effacement, réhydratation	V2-ADR-019, V2-ADR-003, V2-ADR-004, V2-ADR-006, V2-ADR-010, V2-ADR-013, V2-ADR-015, V2-ADR-017	v0.1 (Draft)
